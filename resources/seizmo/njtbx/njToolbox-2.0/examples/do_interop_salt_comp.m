...
uri1='http://geoport.whoi.edu/thredds/dodsC/usgs/vault0/data/examples/forecast/latest/ecom_today.cdf';
ilev1=1; % surface is layer 1
var1='salt';

% UMAINE (Gulf Wide)
%uri2 ='http://coast-enviro.er.usgs.gov/thredds/dodsC/gom_interop/umaine/latest';
uri2='http://geoport.whoi.edu/thredds/dodsC/usgs/vault0/data/examples/gomoos_data/rtofs/latest.cdf'
