...
%uri_mod='http://geoport.whoi.edu/thredds/dodsC/gom_interop/umaine/latest';
%uri_mod='http://rocky.umeoce.maine.edu/gomoos_data/operational/latest.cdf';
%uri_mod='http://geoport.whoi.edu/thredds/dodsC/usgs/vault0/data/examples/gomoos_data/rtofs/latest.cdf';
uri_mod='http://rocky.umeoce.maine.edu/thredds/dodsC/gomoos/operational_model/UMaine_GoMOOS_cirulation_model_best.ncd';
...
ind=find(abs(now_utc-jd)<1); %plot all results within last day
if isempty(ind),
...
[Tc,g] = nj_grid_varget(uri_mod,'temp',[itime,1,1,1],[1,inf,inf,inf],[1,1,1,1]);
